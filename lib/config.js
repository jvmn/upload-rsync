 ...
 * proxy cmd.getYes()
 * 
 * @return {Boolean} executeWithoutPrompt - Flag for verbose output
 */
config.prototype.executeWithoutPrompt = function () {
    return this.cmd && this.cmd.getYes();
};
