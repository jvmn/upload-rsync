...
const argv = yargs
    .usage('$0 [options]')
    .options({
        'prod': { alias: 'p', type: 'string', desc: 'Upload to prod stage', default: false },
        'test': { alias: 't', type: 'string', desc: 'Upload to test stage', default: false },
        'dev': { alias: 'd', type: 'string', desc: 'Upload to dev stage (default)', default: false },
        'verbose': { alias: 'v', type: 'string', desc: 'More information output', default: false }
    })
    .help()
    .version()
    .strict(true)
